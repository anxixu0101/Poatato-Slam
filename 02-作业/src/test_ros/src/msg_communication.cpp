 ...
 * @LastEditTime: 2023-07-10 20:43:02
 */
#include "ros/ros.h"
...
public:
    LaserSub()
    {
        ...
        sub_ = nh_.subscribe<sensor_msgs::PointCloud2>("/kitti/velo/pointcloud", 1000, &LaserSub::chatterCallback);
    }
    static void chatterCallback(const sensor_msgs::PointCloud2::ConstPtr &msg)
    {
...
{
    ros::init(argc, argv, "laser"); //初始化ROS节点
    //LaserPub laser_pub;
